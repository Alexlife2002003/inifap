...
class GraficaPrecipitacion extends StatefulWidget {
  final String title;
  ...
  @override
  State createState() => _GraficaPrecipitacionState();
}

class _GraficaPrecipitacionState extends State<GraficaPrecipitacion> {
